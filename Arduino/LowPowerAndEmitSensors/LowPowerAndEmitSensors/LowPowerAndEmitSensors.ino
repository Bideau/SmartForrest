...
//Nombre de capteurs differents pour la taille max du message
#define NB_FIELDS 7
#define NB_SIZE_FIELD 8
#define NB_MESSAGE_LENGTH NB_FIELDS*NB_SIZE_FIELD
...
char float_str[NB_MESSAGE_LENGTH];
uint8_t message[100];
// receive window
...
void setup()
{
  ...
  // set all setup for sensors
  myDhtSensor.setup(2,myDhtSensor.AM2302);
